...
<AccordionGroup>
  ...
  <Accordion title="Using with Vercel AI SDK">
    ...
    [View full Vercel AI SDK integration guide →](/gateway/integrations/vercel-ai-sdk)
  </Accordion>
  ...
  <Accordion title="Async logging (without proxy)">
    ...
    [View async logging documentation →](/getting-started/integration-method/async)
  </Accordion>
</AccordionGroup>
...
- Browse our [FAQ](/faq/how-we-calculate-cost) for common questions

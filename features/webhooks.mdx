...
description: "Receive real-time notifications when LLM requests complete"
...
<Note>
You can also create webhooks programmatically using our [REST API](/features/webhooks).
</Note>
</Step>
...
Configure your webhook behavior through the [dashboard](https://us.helicone.ai/webhooks) or [REST API](/features/webhooks):

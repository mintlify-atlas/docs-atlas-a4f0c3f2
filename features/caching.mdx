...
description: "Store and reuse LLM responses to reduce costs and latency"
...
<Tab title="FAQ Bot">
  **Scenario**: FAQ bot with 50 common questions, 1000 requests/day
  
  - Without caching: 1000 requests × $0.002 = **$2.00/day**
  - With caching: ~50 unique × $0.002 + 950 cached = **$0.10/day**
  - **Savings: 95%** ($58/month → $3/month)
</Tab>

<Tab title="Testing Suite">
  **Scenario**: Running automated tests with 200 LLM calls
  
  - Without caching: 200 requests × $0.02 = **$4.00 per run**
  - With caching: First run $4.00, subsequent runs **$0.00**
...
<Card title="Rate Limiting" icon="clock" href="/features/rate-limiting">

...
<Tip>
  Jawn's API is fully documented with OpenAPI specs. Explore the [REST API reference](/rest/request/post-v1requestquery).
</Tip>
...
<Card icon="docker">
  ...
  **Includes:**
  ...
  [View self-hosting guide →](/getting-started/self-deploy-docker)
</Card>
